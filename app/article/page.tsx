    ...
    <main className={styles.articleBg}>
      {Object.keys(article).length === 0 ? (
        ...
        <div className={styles.article}>
          ...
          <div>
            Dogs, known as man's best friend, come in various shapes, sizes, and
            temperaments, but they all share a common bond with humans that
            transcends differences. As loyal companions, dogs offer unwavering
            affection, companionship, and protection to their owners. Whether as
            devoted pets, diligent working partners, or compassionate therapy
            animals, dogs continue to hold a special place in our hearts as
            cherished companions, bringing joy and companionship to people of
